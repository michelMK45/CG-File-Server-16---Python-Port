...
class StadiumDialog(BaseDialog):
    def __init__(self, master: tk.Misc, exedir: Path, default_scope: str = "0") -> None:
        ...
        self._build_preview(stadium_preview_row, 0, "Stadium Preview", "stadium", image_size=(360, 210), height=16)
        ...
        self._build_preview(preview_top, 0, "Pitch Preview", "pitch", image_size=(320, 250), height=16)
        self._build_preview(preview_top, 1, "Net Preview", "net", image_size=(320, 250), height=16)
        ...
        self._build_preview(preview_bottom, 0, "Police Preview", "police", image_size=(320, 250), height=16)
